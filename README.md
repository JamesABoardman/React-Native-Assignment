...
<code>These are where I created my Wireframes for designing the application:<code> [Wireframes](https://github.com/JamesHullCS/React-Native-Assignment/tree/master/React%20Wireframes)
